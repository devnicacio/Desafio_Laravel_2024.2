            ...
            <div class="py-6 flex justify-center">
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg p-6 flex justify-center items-center flex-col w-[500px]">
                    ...
                    <div class="flex flex-col w-full">
                        <form id="storeloan" action="{{ route('user-store-loan') }}" method="POST" enctype="multipart/form-data" class="w-full flex flex-col items-center">
                            @csrf
                            @method('POST')
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg p-6 flex justify-center items-center flex-col w-[500px]">
                    ...
                    @endif
                    <div class="flex flex-col w-full">
                        <form id="payloan" action="{{ route('user-pay-loan') }}" method="POST" enctype="multipart/form-data" class="w-full flex flex-col items-center">
                            @csrf
                            @method('POST')
