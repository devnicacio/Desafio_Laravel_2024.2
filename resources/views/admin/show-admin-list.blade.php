<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-md rounded-lg flex justify-between items-center">
                ...
                <div class="px-6">
                    <a href="">
                        <x-safebank-link-button route="admin-show-create-admin">
                            {{"Criar usuário"}}
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg flex justify-between items-center p-4 mb-2">
                    ...
                    @if($user->id != $creator)
                        <div class="flex gap-2 ml-4">
                            <x-safebank-id-link-button route="admin-show-admin" id="{{$user->id}}">
                                <i class="bi bi-eye-fill" style="font-size:17px; color:white"></i>
                            </x-safebank-id-link-button>

                            <x-safebank-id-link-button route="admin-show-edit-admin" id="{{$user->id}}">
    ...
    <script>
        function openDeleteModal(userId) {
            ...
            form.action = `/admin-delete-admin/${userId}`;
