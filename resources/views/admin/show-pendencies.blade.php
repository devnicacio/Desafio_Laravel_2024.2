            ...
            <div>
                ...
                @foreach ($transferPendencies as $transferPendencie)
                    @php
                        ...
                        $user = \App\Models\Manager::where('account', $senderAccount->id)->first();
                    ...
                    <div class="bg-white overflow-hidden rounded-lg grid grid-cols-4 gap-4 mt-4 shadow-sm p-4 mb-2">
                        ...
                        <div class="flex gap-2 ml-4 justify-center items-center">
                            <form action="{{route('admin-accept-pendencie', $transferPendencie->id)}}" method="POST" id="deleteForm">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                            ...
                            <form action="{{route('admin-deny-pendencie', $transferPendencie->id)}}" method="POST" id="deleteForm">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
